...
Matrixf reshapeMatrix (Matrixf input) {
    Matrixf result(1, input.getSize().first * input.getSize().second);
...
void updateWindow (sf::RenderWindow& win, Matrixf results, Matrixf img,
